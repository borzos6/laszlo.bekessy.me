            ...
            <Columns.Column size={6}>
                ...
                <Content>
                    <ul>
                        ...
                        <li>Practical experience in building <span className='has-text-weight-bold'>diverse, multi-language, multi-culture teams</span> (8y)</li>
                        <li>Serial entrepreneur from heart, founded and validated <span className='has-text-weight-bold'>more than 30 projects</span></li>
                    </ul>
                </Content>
            </Columns.Column>
        </Columns>
